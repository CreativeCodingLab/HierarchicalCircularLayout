...
svg = d3.select("#tree-container").append("svg")
  ...
  .append("g")
   ...
   var tree = d3.layout.tree().size([810,480]);
...
// Get JSON data
treeJSON = d3.json("1_Activation of Pro-caspase 8_Nested.json", function(error, treeData) {
    ...
    visit(treeData, function(d) {
        totalNodes++;
        maxLabelLength = Math.max(d.name.length, maxLabelLength)/10;
